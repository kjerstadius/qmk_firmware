...
#define LAYER_HDALT1 KC_W, KC_M, KC_H, KC_F, KC_V, KC_QUOT, KC_Y, KC_U, KC_Q, KC_J, KC_LBRC, KC_RBRC
#define LAYER_HDALT2 LALT_T(KC_R), LGUI_T(KC_S), LSFT_T(KC_N), LCTL_T(KC_T), LT(_LOWER, KC_G), LT(_RAISE, KC_K), RCTL_T(KC_I), RSFT_T(KC_E), RGUI_T(KC_A), LALT_T(KC_O), RALT_T(KC_SCLN)
#define LAYER_HDALT3 KC_X, KC_C, KC_L, KC_D, KC_V, KC_Z, KC_P, KC_COMM, KC_DOT, KC_SLSH
...
#define LAYER_QWERTY2 HOME_A, HOME_S, HOME_D, HOME_F, HOME_G, HOME_H, HOME_J, HOME_K, HOME_L, HOME_SCLN, HOME_QUOT
